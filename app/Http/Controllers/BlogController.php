...
{ 
  //this function iS used for opening the Home screen of application
    ...
    {
    $users=Posts::where('posttype','=','post')->orderBy('updated_at','DESC')->get();
  ...
  //--------------------------------------------
    ...
    public function userDataGet(Request $request)
    {
      ...
      $users=Posts::where('posttype','=','post')->where('user_id','=',$myid)->orderBy('updated_at','DESC')->get();
    ...
    { 
      $users=Posts::where('posttype','=','post')->where('coursetype','=','dance')->orderBy('updated_at','DESC')->get();
      return view('Home',['users' => $users]);
    }
    //--------------------------------------------
    ...
    {  
      $users=Posts::where('posttype','=','post')->where('coursetype','=','singing')->orderBy('updated_at','DESC')->get();
      return view('Home',['users' => $users]);
    }
    //--------------------------------------------
    ...
    {
      $users=Posts::where('posttype','=','post')->where('coursetype','=','publicSpeaking')->orderBy('updated_at','DESC')->get();
      return view('Home',['users' => $users]);
    }
    //--------------------------------------------
     ...
     public function userDance(Request $request)
    {
      ...
      $users=Posts::where('posttype','=','post')->where('coursetype','=','dance')->orderBy('updated_at', 'ASC')->get();
      return view('Dashboard',['users' => $users,'data'=>$data]);
     }
     //--------------------------------------------
    ...
    {
      $myid=session()->get('loginId');
      $users=Posts::where('posttype','=','draft')->where('user_id','=',$myid)->orderBy('updated_at', 'DESC')->get();
      return view('Userdata',['users' => $users]);  
    }
    //-----------------------------------------
    //this function is just for checking the one to many relationship between the user and posts
